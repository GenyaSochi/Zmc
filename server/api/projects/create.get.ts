...
export default defineEventHandler(async (event) => {
  ...
  const projects = [
    ...
    { id: 5, name: 'Опоры неподвижные в ППУ изоляции', project: 'Опоры типа 5-А для надземной прокладки с устройством электрообогрева', quantity: '12 тонн, 70 штук', year: 2021, enduser: 'Строительная компания', img: '/img/opt4.webp' },
