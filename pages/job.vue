<template>
    ...
    <div>
        ...
        <br>
        <p class="text">Наша цель – создать комфортные условия для работы, чтобы вы могли сосредоточиться на главном – своем развитии и успехе.</p>
        <br>
        ...
        <br>
        <p class="text">По всем интересующим вопросам обращайтесь по телефону <b>+79000244766</b> 
